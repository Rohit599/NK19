...
if(isset($_SESSION['user']))
{
	...
	{
		echo "<script>
		window.location = 'level7.php?answer=';
		</script>";
		die();
	}
	if(isset($_GET['answer']))
	{
		if ($_GET['answer']=="eyeofprovidence") {
			$sql="UPDATE users SET level=8,last_time='".date('Y-m-d H:i:s')."' WHERE email='".$_SESSION['user']."'";
			$result=mysqli_query($con,$sql);
			echo "<script>
...
<body style="background-color: black">
	<div class="level">
		<img src="assets/nk/8-illuminati.jpg">
	</div>
